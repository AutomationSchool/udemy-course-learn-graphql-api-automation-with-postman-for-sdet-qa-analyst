...
module.exports = {
  ...
  Query: {
    ...
    searchAuthors: (obj, args, { data }) => {
      const searchTerm = args.searchTerm;
      const regex = new RegExp(searchTerm, "i"); //case insensitive
      
      const results = data.authors.filter(author => {
        return regex.test(author.firstName) || regex.test(author.lastName) || regex.test(author.shortBio)
      });
      return results || [];
    },
  },
